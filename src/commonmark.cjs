...
/* this version has been tweaked at line 8644 and 8645 to allow HTML open tags to
   to be capitalized to start an html_block instead of wrapping it with <p> tag */
(function (global, factory) {
    ...
    var reHtmlBlockOpen = [
        ...
        /^<![A-Za-z]/,
        /^<!\[CDATA\[/,
        /^<[/]?(?:(?:[A-Z][a-zA-Z0-9\-]*)|address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[123456]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|nav|noframes|ol|optgroup|option|p|param|section|search|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul)(?:\s|[/]?[>]|$)/,
